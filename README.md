...
<h1 align="center">@Vue Component - vc-steps</h1>
...
`import vc-steps from 'vc-steps/src/components/steps.vue'`
...
[changelog](https://github.com/iwaimai-bi-fe/vc-steps/blob/master/CHANGELOG.md) 
